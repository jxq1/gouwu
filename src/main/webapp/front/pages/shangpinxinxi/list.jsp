          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="shangpinmingcheng" id="shangpinmingcheng" placeholder="服装名称" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
              <label class="layui-form-label">服装分类</label>
              <div class="layui-input-inline">
                <input type="text" name="shangpinfenlei" id="shangpinfenlei" placeholder="服装分类" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
