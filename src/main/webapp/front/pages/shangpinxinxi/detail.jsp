        ...
        <div class="layui-row">
            ...
            <div class="layui-col-md7" style="padding-left: 20px;">
                ...
                <div class="detail-item">
                    ...
                    <button @click="buyTap(1)" type="button" class="layui-btn btn-submit">
                        余额购买
                    </button>
                    <button @click="buyTap(2)" type="button" class="layui-btn btn-submit">
                        积分购买
                    </button>
...
<script>
    var vue = new Vue({
        ...
        methods: {
            ...
            addCartTap() {
                ...
                // 库存限制
                if ((this.detail.shuliang.toString() && this.detail.shuliang.toString() > 0 && this.detail.shuliang.toString() < this.buynumber.toString())||this.detail.shuliang.toString()<=0) {
                    layer.msg(`服装库存不足`, {
                        time: 2000,
                        icon: 5
                    });
            ...
            // footPrint() {
            //     layui.http.requestJson('footprint/save', 'post', {
            //         userid: localStorage.getItem('userid'),
            //         footname: this.title,
            //         footpicture: this.swiperList[0],
            //         footid: this.detail.id,
            //         tablename: this.detailTable
            //     }, function (res) {
            //         layer.msg(`记录成功`, {
            //             time: 2000,
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        // footPrint();
        // // 加入足迹
        // http.requestJson('footprint/save', 'post', {
        //     userid: localStorage.getItem('userid'),
        //     footname: this.title,
        //     footpicture: this.swiperList[0],
        //     footid: this.detail.id,
        //     tablename: this.detailTable,
        //     foottime:this.detail.clicktime
        // }, function (res) {
        //     layer.msg(`记录成功`, {
        //         time: 2000,
        //         icon: 6
