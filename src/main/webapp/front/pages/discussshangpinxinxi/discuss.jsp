...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        // 数据ID
        var goodid =  http.getParam("goodid");
        vue.detail.id = goodid;
        // 商品信息
        http.request('${vue.detailTable}/detail/' + goodid, 'get', {}, function (res) {
            // 详情信息
            vue.detail = res.data;
        ...
        // // 订单信息
        // http.request('orders/detail/' + id, 'get', {}, function (res) {
        //     // 详情信息
        //     vue.detail = res.data;
        //     vue.title = vue.detail.goodname;
        //
        // });
