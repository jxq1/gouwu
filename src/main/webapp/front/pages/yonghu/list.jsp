  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#useraccount').val()) {
          param['useraccount'] = jquery('#useraccount').val() ? '%' + jquery('#useraccount').val() + '%' : '';
        }  
        if (jquery('#uusername').val()) {
          param['uusername'] = jquery('#uusername').val() ? '%' + jquery('#uusername').val() + '%' : '';
        }  
        // 获取列表数据
