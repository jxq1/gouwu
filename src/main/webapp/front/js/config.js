...
var adminurl =  "http://localhost:8080/gouwu/index.jsp";
...
var menu = [{
           "backMenu":[{
               ...
               "child":[{
                   ...
                   "buttons":["新增","查看","修改","删除"],
                   "menu":"轮播图管理","tableName":"lunbotuguanli"
               }],
               "menu":"系统管理"
           }, {
               "child":[{
    ...
    },
    {
        "backMenu":[{
            ...
            "child":[{
                ...
                "buttons":["新增","查看","删除","发货"],
                "menu":"已支付订单","tableName":"yizhifudingdan"
            },{
                "buttons":["新增","查看","修改","删除"],
                "menu":"已退款订单",
                "tableName":"yituikuandingdan"
                ...
                "menu":"已发货订单","tableName":"yifahuodingdan"
            },{
                "buttons":["新增","查看","修改","删除"],
                "menu":"未支付订单","tableName":"weizhifudingdan"
            }],
            "menu":"订单管理"
        }],
        "frontMenu":[{
