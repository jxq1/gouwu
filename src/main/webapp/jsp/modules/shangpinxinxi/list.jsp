				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">服装信息列表</h3>
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
									...
									<label>
										规格
										<input type="text" id="guigeSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shangpinbianhao')">服装编号<i id="shangpinbianhaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shangpinmingcheng')">服装名称<i id="shangpinmingchengIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shangpinfenlei')">服装分类<i id="shangpinfenleiIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('flag')">是否上架<i id="flagIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
