		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">查看服装信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">查看服装信息</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>是否上架？1：是 2：否</label>

										<input id="flag" name="flag" class="form-control" v-model="ruleForm.flag" readonly>
									</div>
									<div class="form-group col-md-6">
									...
									<div class="form-group  col-md-12"><label>详情</label>
