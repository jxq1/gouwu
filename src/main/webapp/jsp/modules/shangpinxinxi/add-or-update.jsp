		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑服装信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">服装信息管理</li>
								<li class="breadcrumb-item active">编辑服装信息</li>
							</ol>
						</div>
					</div>
				</div>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="shangpinbianhao" name="shangpinbianhao" class="form-control" value="" readonly>
											...
											<div class="form-group col-md-6">
										<label>服装名称</label>
										<input id="shangpinmingcheng" name="shangpinmingcheng" class="form-control" placeholder="服装名称">
									</div>
											<div class="form-group col-md-6">
										<label>服装分类名称</label>
									...
									<div class="form-group col-md-6">
										<label>积分</label>
										<input id="jifen" type="number" name="jifen" class="form-control" placeholder="积分">
									</div>
									<div class="form-group col-md-6">
										<label>是否上架</label>
										<input id="flag" type="number" name="flag" class="form-control" placeholder="是否上架？是：1 否：2">
									</div>
        ...
        function crossTable(){
            ...
            if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					...
					if(res.data != null && res.data != '' && res.data.flag != null && res.data.flag != ''){
