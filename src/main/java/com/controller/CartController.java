...
public class CartController {
    ...
    public R selectIds(@RequestBody String[] ids){
//        List<CartEntity > cartEntities = cartService.selectBatchIds(Arrays.asList(ids));
        return R.ok().put("data",cartService.selectBatchIds(Arrays.asList(ids)));
    }
