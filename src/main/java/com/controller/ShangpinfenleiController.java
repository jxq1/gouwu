...
public class ShangpinfenleiController {
    ...
    public R save(@RequestBody ShangpinfenleiEntity shangpinfenlei, HttpServletRequest request){
        ...
        ShangpinfenleiEntity shangpinfenleiEntity = shangpinfenleiService.selectOne(new EntityWrapper<ShangpinfenleiEntity>().eq("shangpinfenlei", shangpinfenlei.getShangpinfenlei()));
        if(shangpinfenleiEntity!=null) {
